...
public class CuentaController {
    ...
    @GetMapping("/correo")
    public ResponseEntity<Cuenta> buscarcorreo(@RequestParam @NotBlank String email){
        return ResponseEntity.ok(service.buscarCorreo(email));
    }

    @GetMapping("/estado")
    public ResponseEntity<List<Cuenta>> buscarestado(@RequestParam @NotBlank String estado){
