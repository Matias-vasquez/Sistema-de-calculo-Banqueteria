...
public class Platillocontroller {
    ...
    @GetMapping("{id}")
    public ResponseEntity<Platillo> buscarXId(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Platillo> actualizar(@PathVariable @NotEmpty Long id, @RequestBody @Valid Platillo platilloActualizado){
